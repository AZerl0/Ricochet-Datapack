...
# text
    ...
    $tellraw @s [{"storage": "ricochet:translate","nbt": "values.'ui.error_log'","color":"aqua","hoverEvent": {"action": "show_text","contents": {"translate": "chat.copy.click"}},"clickEvent": {"action": "copy_to_clipboard","value": $(error_log)}}]
